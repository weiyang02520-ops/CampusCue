...
class LogManager:
    ...
    _NOISY_LOGGER_LEVELS: dict[str, int] = {
        ...
        # On Windows, the ProactorEventLoop logs a warning every time a write
        # lands on a closed SSE connection -- routine when a board tab closes.
        # WARNING still floods the file (hundreds of thousands of lines);
        # ERROR keeps real asyncio failures visible while silencing that.
