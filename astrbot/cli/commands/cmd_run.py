...
async def run_astrbot(astrbot_root: Path) -> None:
    """Run AstrBot"""
    # Register the campus tables before the core imports, so db.initialize()'s
    # create_all creates them on a fresh checkout -- see main.py for the full
    # explanation of the ordering trap.
    import campuscue.models  # noqa: F401
