...
def create_dashboard_asgi_app(
    *,
    ...
    # CampusCue's board SPA, before the dashboard's catch-all static route --
    # which would otherwise answer /campus with the admin dashboard's index.
    from campuscue.api.static import install_campus_static

    install_campus_static(app)
