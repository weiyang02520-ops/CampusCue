...
External final review of `.ai-handoff/visual/m6-final-candidate/` is required。GLASS FINAL、DARK FINAL、NEUMORPHISM FINAL 均 awaiting external final review；M6 FINAL = IMPLEMENTATION_COMPLETE_AWAITING_EXTERNAL_FINAL_REVIEW；M7 is not authorized。
